...
Same abs-integral signal as absint_proportional, but instead of instant attack
with slow decay, both the rise AND fall are smoothed equally. The LED breathes
up and down with the music rather than snapping on and fading off.

Attack and decay rates are matched (~0.85), giving a sine-like envelope.
The result is gentler, more organic — good for ambient and slower music.
"""
