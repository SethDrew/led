...
*Target: `/audio-reactive/research/STATUS.md`*
...
8. **The streaming-audio directory has TWO older implementations** (basic-audio-reactive and scottlawsonbc-spectrum) that preceded the audio-reactive/research tools. Understanding this lineage helps contextualize the project evolution.
